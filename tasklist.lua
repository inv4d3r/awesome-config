...
local function tasklist_label(c, args)
    ...
    local tasklist_disable_icon = true --args.tasklist_disable_icon or theme.tasklist_disable_icon or false
    ...
    local maximized_horizontal = args.maximized_horizontal or theme.tasklist_maximized_horizontal or 'sticky-- '

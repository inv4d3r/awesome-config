...
--theme.taglist_squares_sel = "~/.config/awesome/themes/taglist/square_bottom.png"
theme.taglist_squares_sel = "~/.config/awesome/themes/taglist/square_bottom_sel.png"
theme.taglist_squares_unsel = "~/.config/awesome/themes/taglist/square_bottom_unsel.png"
